...
class LarkManager:
    # how to get user_access_token:https://open.feishu.cn/api-explorer/cli_a0351fe3a778900e?apiName=app_ticket_resend&project=auth&resource=auth&state=&version=v3
